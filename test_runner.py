...
class TestRunner:
    ...
    def _get_quite_logs(self):
        for test_logs in self._logs:
            if all([not isinstance(log, str) for log in test_logs]):
                print('+', end="")
            else:
                print('-', end="")
    ...
    def _get_logs(self):
        ...
        for test_num, logs in enumerate(self._logs):
            ...
            result_log_table.add_row([test_num,
